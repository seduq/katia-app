...
const Schema: z.ZodType<Prisma.CommentUncheckedCreateNestedManyWithoutCustomerInput> =
  z
    .object({
      create: z
        .union([
...
export const CommentUncheckedCreateNestedManyWithoutCustomerInputObjectSchema =
  Schema;
