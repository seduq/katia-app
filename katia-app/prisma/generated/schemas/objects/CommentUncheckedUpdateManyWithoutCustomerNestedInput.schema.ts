...
const Schema: z.ZodType<Prisma.CommentUncheckedUpdateManyWithoutCustomerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CommentUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema =
  Schema;
