...
const Schema: z.ZodType<Prisma.CustomerUncheckedUpdateWithoutCommentsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const CustomerUncheckedUpdateWithoutCommentsInputObjectSchema = Schema;
