...
const Schema: z.ZodType<Prisma.CustomerUncheckedUpdateWithoutSchedulesInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const CustomerUncheckedUpdateWithoutSchedulesInputObjectSchema = Schema;
