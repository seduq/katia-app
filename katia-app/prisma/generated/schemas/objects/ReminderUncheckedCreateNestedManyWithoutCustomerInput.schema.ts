...
const Schema: z.ZodType<Prisma.ReminderUncheckedCreateNestedManyWithoutCustomerInput> =
  z
    .object({
      create: z
        .union([
...
export const ReminderUncheckedCreateNestedManyWithoutCustomerInputObjectSchema =
  Schema;
