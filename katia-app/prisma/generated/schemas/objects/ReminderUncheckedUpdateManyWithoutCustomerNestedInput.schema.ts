...
const Schema: z.ZodType<Prisma.ReminderUncheckedUpdateManyWithoutCustomerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ReminderUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema =
  Schema;
