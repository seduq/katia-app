...
const Schema: z.ZodType<Prisma.ScheduleCreateNestedManyWithoutCustomerInput> = z
  .object({
    create: z
      .union([
...
export const ScheduleCreateNestedManyWithoutCustomerInputObjectSchema = Schema;
