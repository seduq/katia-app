...
const Schema: z.ZodType<Prisma.ScheduleUncheckedCreateNestedManyWithoutEmployeeInput> =
  z
    .object({
      create: z
        .union([
...
export const ScheduleUncheckedCreateNestedManyWithoutEmployeeInputObjectSchema =
  Schema;
