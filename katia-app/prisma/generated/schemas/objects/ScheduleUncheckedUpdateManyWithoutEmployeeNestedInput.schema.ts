...
const Schema: z.ZodType<Prisma.ScheduleUncheckedUpdateManyWithoutEmployeeNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ScheduleUncheckedUpdateManyWithoutEmployeeNestedInputObjectSchema =
  Schema;
