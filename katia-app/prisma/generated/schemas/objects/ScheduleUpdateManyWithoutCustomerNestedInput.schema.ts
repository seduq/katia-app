...
const Schema: z.ZodType<Prisma.ScheduleUpdateManyWithoutCustomerNestedInput> = z
  .object({
    create: z
      .union([
...
export const ScheduleUpdateManyWithoutCustomerNestedInputObjectSchema = Schema;
